...
//!
//! Each tunnel owns a `State:/Network/Service/com.local.splitwg-<iface>/DNS`
//! entry. `scutil` is fed a small script on stdin:
//!
//! ```text
//! d.init
//! d.add ServerAddresses * 1.1.1.1 1.0.0.1
//! set State:/Network/Service/com.local.splitwg-utun4/DNS
//! quit
//! ```
//!
...
const KEY_PREFIX: &str = "State:/Network/Service/com.local.splitwg-";
